  ...
  return (
    <div className="band band-paper pb-24 pt-16">
      <div className="wrap">
        ...
        <h1 className="h2 mt-4">Selected systems and sites</h1>
        <p className="lede mt-4">Real products and client properties. Live URLs are linked where the site is public.</p>
